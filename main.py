...
#from correlacao_seeg import mostrar_pagina_correlacao   
from Analise_estatistica import mostrar_pagina_comparacao
...
pagina = st.sidebar.radio(
    "Selecione a Página:",
    ["Carregue Seus Dados", "Resumo Geral EQ", "Desagregados por Categoria", "Tendência de Emissão", "Correlação com SEEG"]
)
...
#elif pagina == "Correlação SEEG":
#    mostrar_pagina_correlacao()

elif pagina == "Tendência de Emissão":
    mostrar_pagina_tendencia()

elif pagina == "Analise estatistica":
